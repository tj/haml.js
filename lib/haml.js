...
Parser.prototype = {
  ...
  get iterate() {
    ...
    return '(' + exports.templates.iterate
      .replace(/__vals__/g, plural)
      .replace(/__val__/g, singular)
      .replace(/__block__/g, this.block) + ').call(this)'
  },
...
exports.render = function(str, options) {
  ...
  return (function(){
    with (options.locals || {}) {
      return eval((new Parser(str, options)).js)
    }
